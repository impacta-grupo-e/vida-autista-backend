...
namespace VidaAutistaDotnet.Infra.Data.Repositories
{
    public class CalendarioRepository : ICalendarioRepository
    {
        ...
        public Calendario Add(Calendario objeto)
        {
            ...
            string sql = "INSERT INTO calendario(id_usuario,nome_medico,especialidade_medico, anotacoes, data_hora_evento, tipo_evento) " +
              "VALUES(@idUsuario,@nomeMedico,@especialidadeMedico,@anotacoes,@dataHoraEvento, @tipoEvento); " +
